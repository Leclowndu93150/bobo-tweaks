...
public class RejuvenatingShotsEffect extends MobEffect {
    ...
    /**
     * Called by AbstractArrowMixin to handle healing allies with arrows.
     * This runs before Minecraft's canHarmPlayer check, so it works even with friendlyFire=false.
     *
     * @return true if the target was healed (arrow should be discarded), false otherwise
     */
    public static boolean tryHealAlly(AbstractArrow arrow, Player shooter, LivingEntity target) {
